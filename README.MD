...
> **Personal fork note:** I'm using this primarily for learning purposes and testing on my home lab. My setup uses AES encryption with 3 resolvers in round-robin mode. If you're just getting started, I recommend reading the DNSTT docs first for background context.
